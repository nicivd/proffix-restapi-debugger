 ...
 */
@Injectable()
export class PxLocalStorageService {
  ...
  /**
   * Überprüft ob das Objekt mit dem angegebenen Schlüssel im LocalStorage vorhanden ist
   * @param key 
   * @returns 'true' if item is in the localStorage
   */
  ...
  public key(index: number): string {
    return window.localStorage.key(index) ?? ""; // TODO: MSC is empty string correct ?
  }
}
